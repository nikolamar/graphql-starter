              ...
              <Form>
                ...
                >
                  {countriesData.map((country, idx) => (
                    <option key={country.countryCode} value={idx}>{`${country.countryNameEn} (+${country.countryCallingCode})`}</option>
                  ))}
                </Select>
                <Box mt={4}/>
                <InputField
                ...
                <Button mt={4} isFullWidth={true} colorScheme="facebook" leftIcon={<FaFacebook />}>
                  Facebook
                </Button>
                <Button mt={4} isFullWidth={true} colorScheme="twitter" leftIcon={<FaTwitter />}>
                  Twitter
                </Button>
                <Button mt={4} isFullWidth={true} colorScheme="red" leftIcon={<FaGoogle />}>
                  Google
                </Button>
              </Form>
            )}
