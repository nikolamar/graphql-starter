...
export class tables1612037207280 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "votes" ("value" integer NOT NULL, "userId" integer NOT NULL, "reviewId" integer NOT NULL, CONSTRAINT "PK_93043c6967a67856b9589346331" PRIMARY KEY ("userId", "reviewId"))`);
        await queryRunner.query(`CREATE TABLE "reviews" ("id" SERIAL NOT NULL, "message" text NOT NULL, "likes" integer NOT NULL DEFAULT '0', "dislikes" integer NOT NULL DEFAULT '0', "hotelId" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_231ae565c273ee700b283f15c1d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "hotels" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "city" character varying NOT NULL, "country" character varying NOT NULL, "image" character varying NOT NULL, "description" text NOT NULL, "location" character varying NOT NULL, "stars" integer NOT NULL DEFAULT '0', "price" integer NOT NULL DEFAULT '0', "userId" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2bb06797684115a1ba7c705fc7b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "votes" ADD CONSTRAINT "FK_797be9842556f00436f8fc5d5fd" FOREIGN KEY ("reviewId") REFERENCES "reviews"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "reviews" ADD CONSTRAINT "FK_a7cc013c66ce20ff12a192c6222" FOREIGN KEY ("hotelId") REFERENCES "hotels"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "hotels" ADD CONSTRAINT "FK_d993201c8aab1a4681dbd53286b" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "hotels" DROP CONSTRAINT "FK_d993201c8aab1a4681dbd53286b"`);
        await queryRunner.query(`ALTER TABLE "reviews" DROP CONSTRAINT "FK_a7cc013c66ce20ff12a192c6222"`);
        await queryRunner.query(`ALTER TABLE "votes" DROP CONSTRAINT "FK_797be9842556f00436f8fc5d5fd"`);
